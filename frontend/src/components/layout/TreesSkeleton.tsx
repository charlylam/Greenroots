...
export default function TreesSkeleton() {
  return (
    <>
      {/* Barre de filtres */}
        ...
        {[...Array(6)].map((_, i) => (
          ...
          >
            ...
            <div className="flex flex-col items-center space-y-4 p-6">
              <Skeleton className="h-6 w-2/3 bg-brand-dark/10" />
              <Skeleton className="h-4 w-1/2 bg-brand-dark/10" />
              <Skeleton className="h-8 w-24 bg-brand-dark/10" />
